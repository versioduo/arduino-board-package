...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_PROXIMITY_SHUTDOWN]  = {PORTA, 18, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_PROXIMITY_INTERRUPT] = {PORTA, 19, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3}};
