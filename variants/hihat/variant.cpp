...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_PULSE_CURRENT_SENSE]     = {PORTB, 9, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel3, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_PULSE_ENABLE]            = {PORTA, 6, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_PULSE_CHANNEL + 0]       = {PORTB, 13, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC3_CH1, EXTERNAL_INT_NONE},
  [PIN_PULSE_CHANNEL + 1]       = {PORTB, 14, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC4_CH0, EXTERNAL_INT_NONE},
  ...
  [PIN_STEP_ENABLE]             = {PORTB, 23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_STEP_SELECT]             = {PORTB, 16, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_STEP_STEP]               = {PORTA, 15, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC2_CH1, EXTERNAL_INT_NONE},
};
