...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_STEPPER_ENABLE]          = {PORTB, 23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_STEPPER_SELECT]          = {PORTB, 16, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_STEPPER_STEP]            = {PORTA, 15, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC2_CH1, EXTERNAL_INT_NONE},
};
