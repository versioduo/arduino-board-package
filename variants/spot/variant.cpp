...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_SERIAL_SOCKET_TX_ENABLE] = {PORTB, 9, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_PWM_CHANNEL + 0]         = {PORTB, 13, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC3_CH1, EXTERNAL_INT_NONE},
  [PIN_PWM_CHANNEL + 1]         = {PORTB, 14, PIO_TIMER_ALT, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC4_CH0, EXTERNAL_INT_NONE},
};
