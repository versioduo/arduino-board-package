...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_CHANNEL_SENSE + 0] = {PORTB, 9, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel3, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE},
  [PIN_CHANNEL_SENSE + 1] = {PORTB, 8, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel2, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}};
