...
const PinDescription g_APinDescription[PIN_MAX] = {
  ...
  [PIN_FADER_TOUCH]               = {PORTA, 7, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7},
  ...
  [PIN_KEY + 0]                   = {PORTB, 10, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10},
  [PIN_KEY + 1]                   = {PORTB, 8, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8},
  [PIN_KEY + 2]                   = {PORTB, 9, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9},
  [PIN_KEY + 3]                   = {PORTB, 3, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3},
  ...
  [PIN_DISPLAY_BACKLIGHT]         = {PORTA, 15, PIO_TCC_PDEC, PIN_ATTR_TIMER, No_ADC_Channel, NOT_ON_PWM, TCC1_CH3, EXTERNAL_INT_NONE}};
